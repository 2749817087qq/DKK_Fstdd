...
SKILL_META = {
    ...
    "build": {
        "name": "stdd-build",
        "description": "STDD Phase 3: BUILD — 切片规划 + TDD 实现 + 质量验证（SLICE/BUILD/VERIFY 合并）",
        "keywords": ["stdd-build", "TDD实现", "build", "slice", "verify"],
    },
    "deliver": {
        "name": "stdd-deliver",
        "description": "STDD Phase 4: 交付 — 归档 change、合并 specs、更新文档",
...
def cmd_install(args: argparse.Namespace) -> None:
    ...
    if platform == "claude-code":
        print("   /fstdd-understand  <需求>    启动新变更")
        print("   /fstdd-spec                  进入规格设计")
        print("   /fstdd-continue              继续执行")
