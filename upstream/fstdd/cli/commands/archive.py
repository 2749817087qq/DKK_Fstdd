...
def cmd_archive(args: argparse.Namespace) -> None:
    ...
    if state_file.exists():
        ...
        # V3.0.5: build is the merged phase; tolerate legacy 6-phase verify status.
        build_done = state.get("phases", {}).get("build", {}).get("status") == "completed"
        legacy_verify_done = state.get("phases", {}).get("verify", {}).get("status") == "completed"
