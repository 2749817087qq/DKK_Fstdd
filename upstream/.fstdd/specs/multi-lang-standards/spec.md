...
- **THEN** 系统 SHALL 读取 `.fstdd/standards/java.md` 文件
...
- **GIVEN** `.fstdd/standards/python.md` 存在且包含 7 个章节
...
- **THEN** 系统 SHALL 读取 `.fstdd/standards/go.md` 文件
...
- **THEN** 系统 SHALL 读取 `.fstdd/standards/rust.md` 文件
...
- **THEN** 系统 SHALL 读取 `.fstdd/standards/typescript.md` 文件
...
- **GIVEN** `.fstdd/standards/` 下存在 python.md / java.md / go.md / rust.md / typescript.md
